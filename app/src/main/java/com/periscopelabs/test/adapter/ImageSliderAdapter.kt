...
class ImageSliderAdapter (private val context: Context, private val imageList: List<Int>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val itemView: View = mLayoutInflater.inflate(R.layout.image_slides, container, false)
        val imageView: ShapeableImageView = itemView.findViewById<ShapeableImageView>(R.id.image)
